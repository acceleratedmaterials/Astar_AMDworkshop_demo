...
net = tflearn.gru(net, 128, dropout=0.5)
...
model.fit(trainX, trainY, validation_set=(testX, testY), show_metric=True,
		batch_size=32, n_epoch=150)
		  
model.save('./saved/tf/gru/model.tfl')