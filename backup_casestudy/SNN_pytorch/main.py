...
def next_pair(batch_number, is_train=True):
    ...
    batch_label_1 = Variable(batch_label_1)          # create a torch variable and transfer it into GPU

    batch_label_2 = torch.from_numpy(batch_label_2).long()  # convert the numpy array into torch tensor
    batch_label_2 = Variable(batch_label_2)          # create a torch variable and transfer it into GPU
    ...
    batch_label_c = Variable(batch_label_c)           # create a torch variable and transfer it into GPU

    batch_img_1 = torch.from_numpy(batch_img_1).float()     # convert the numpy array into torch tensor
    batch_img_1 = Variable(batch_img_1)              # create a torch variable and transfer it into GPU

    batch_img_2 = torch.from_numpy(batch_img_2).float()  # convert the numpy array into torch tensor
    batch_img_2 = Variable(batch_img_2)           # create a torch variable and transfer it into GPU
