...
3 CNN layers each with 128 units, Max pooling 
Optimizer: Adam
Epoch: 500
...
model.fit(trainX, trainY, n_epoch = 500, shuffle=True, validation_set=(testX, testY), show_metric=True, batch_size=32)

model.save('./saved/tf/cnn_max_pooling/model.tfl')